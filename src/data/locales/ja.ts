...
export const products: Product[] = [
  {
    ...
    name: "有機上煎茶 千代の友",
    description:
      "静岡県富士市の富士山麓、清らかな水と肥沃な大地で育てられた、農薬不使用の有機上煎茶です。太陽の光をたっぷりと浴びた新芽のみるい（柔らかい）部分のみを丁寧に収穫し、伝統的な中深蒸し製法で仕上げました。浅めの火入れにより、茶葉本来の爽やかな香りと上品な甘み、心地よい渋みのバランスが絶妙に調和しています。一口含むと、まるで朝露を含んだ新緑の香りが口いっぱいに広がり、後味には優しい甘みが残ります。農薬不使用・有機栽培で育てられた安心安全なお茶は、毎日の健康的な生活をサポートします。",
    price: 10, // USD
    category: "煎茶",
    image: {
      url: "/images/products/chiyo.webp",
      alt: "富士市 有機上煎茶 千代の友 - 聚楽苑",
      width: 400,
      height: 400,
    },
    subImages: [
